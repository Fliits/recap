...
for (const restaurant of restaurants) {
  ...
  tr.addEventListener('click', function () {
    ...
    const cityAndPostal = document.createElement('p');
    cityAndPostal.innerText = `${restaurant.postalCode} ${restaurant.city}`;
    ...
    modal.append(cityAndPostal);
    modal.append(phone);
    modal.append(company);
  });
